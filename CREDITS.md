...
Every bundled asset (music, SFX, sprites) must be CC0 and listed here — same PR that adds the asset adds the entry. "Royalty-free" is not sufficient; redistribution rights must be verified.
...
| `sfx-transition-whoosh.ogg` — `forceField_000.ogg` from Kenney "Sci-Fi Sounds" | SFX | https://kenney.nl/assets/sci-fi-sounds | CC0 1.0 (stated on asset page and in License.txt inside the pack) | scene-cut transition whoosh (both packs) |
| `sfx-tension-drone.ogg` — `engineCircular_000.ogg` from Kenney "Sci-Fi Sounds" | SFX | https://kenney.nl/assets/sci-fi-sounds | CC0 1.0 (stated on asset page and in License.txt inside the pack) | tension drone on action fail streaks |
| `sfx-end-stinger.ogg` — `jingles_PIZZI07.ogg` from Kenney "Music Jingles" | SFX | https://kenney.nl/assets/music-jingles | CC0 1.0 (stated on asset page and in License.txt inside the pack) | stats end-card stinger |
